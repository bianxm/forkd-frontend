...
export default function Footer(){
    ...
    <div className="flex flex-col py-5 px-5">
        <div className="flex text-s justify-center hover:text-indigo-800"><a href='https://github.com/bianxm/forkd-frontend' target="_blank" rel="noopener noreferrer"><img src='/github-mark.png' className="w-5 h-5 inline mr-1 align-text-bottom"></img>Created by Bianca Matthews</a></div>
