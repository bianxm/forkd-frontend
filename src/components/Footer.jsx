export default function Footer(){
    ...
    <div className="flex-col py-5">
        <div className="flex text-s justify-center"><a href='https://github.com/bianxm/forkd-frontend'><img src='/src/assets/github-mark.png' className="w-5 h-5 inline mr-1 align-text-bottom"></img>Created by Bianca Matthews</a></div>
        ...
        <div className="flex text-xs items-center justify-center"> Emoji patterns from <a href="https://emoji.supply/" className="ml-1">emoji.supply</a></div>
    </div>
    );
}