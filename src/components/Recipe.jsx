...
const RecipeDetails = ({ recipe, edits, setEdits }) => {
  ...
  <div className="md:w-7/12 w-full px-2 bg-stone-50 pb-16">
      <div className="h-40 bg-red-300">
        <img src={recipeEditData.img_url? recipeEditData.img_url : '/pattern.png'} className="object-cover mix-blend-multiply h-full w-full"/>
      </div>
...
const Experiment = ({experiment, canExperiment, canEdit, exps, setExps }) => {
  ...
  <Disclosure as="li" className="relative border-l border-gray-200 pb-10 pl-6">
    ...
    <Disclosure.Button as="div" className="flex flex-col hover:bg-indigo-50">
      <p><Link className="text-md text-gray-500 hover:text-indigo-600" to={`/${experiment.commit_by}`}><img className="inline w-4 h-4 rounded-full" src={experiment.commit_by_avatar ? experiment.commit_by_avatar : '/av4.jpg'}/> {experiment.commit_by}/</Link></p>
...
const Created = ({edit}) => {
  ...
  <Disclosure as="li" className="pl-6 relative">
    ...
    <Disclosure.Button as="div" className="flex flex-col hover:bg-indigo-50">
      <p><Link className="text-md text-gray-500 hover:text-indigo-600" to={`/${edit.commit_by}`}><img className="inline w-4 h-4 rounded-full" src={edit.commit_by_avatar ? edit.commit_by_avatar : '/av4.jpg'}/> {edit.commit_by}/</Link></p>
